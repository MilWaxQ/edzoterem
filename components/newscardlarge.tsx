...
const NewsCardLarge: React.FC<NewsCardLargeProps> = ({title, body, image, invert}) => {
  return (
    invert ? 
    <div className="w-full lg:h-[90vh] flex lg:flex-row flex-col-reverse items-center justify-start">
      <div className="w-full h-full flex flex-col items-center justify-center">
        <p className="text-3xl lg:text-5xl uppercase tracking-widest font-light text-center mt-4 lg:mt-0">{title}</p>
        <p className="p-8 font-light tracking-wider text-neutral-300 text-center">{body}</p>
      </div>
      <div className="w-full h-full relative min-h-96 lg:min-h-0">
    ...
    <div className="w-full lg:h-[90vh] flex lg:flex-row flex-col items-center justify-start">
      <div className="w-full h-full relative min-h-96 lg:min-h-0">
