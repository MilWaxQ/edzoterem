...
const TicketCard: React.FC<TicketCardProps> = ({title, price}) => {
  return (
    <div className={`w-[420px] h-[200px] bg-neutral-900 border border-red-500 rounded-xl shadow-lg hover:shadow-2xl hover:shadow-black/80 shadow-black/50 flex flex-col items-center justify-between p-8 transition ${title === "" ? "opacity-0" : "opacity-100"}`}>
